 ...
 */
function onOpen(e) {
  SlidesApp.getUi().createAddonMenu().addItem("Start", "showSidebar").addToUi();
}
...
function getStyle(equationStringEncoded, quality, renderer, isInline, type, red, green, blue) {
  //ERROR?
  var equation = [];
...
function getElementFromIndices(slideNum, elementNum) {
  ...
  if (element_type == SlidesApp.PageElementType.SHAPE) {
